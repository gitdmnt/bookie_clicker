...
async fn main(req: Request, env: Env, _ctx: Context) -> Result<Response> {
    ...
    router
        ...
        .post_async("/api/isbn/parse", handlers::books::parse_isbn)
        
        // ReadingLog operations
        .post_async("/api/reading-logs", handlers::reading_logs::add_reading_log)
        .get_async("/api/reading-logs", handlers::reading_logs::select_reading_logs)
        .delete_async("/api/reading-logs", handlers::reading_logs::delete_reading_logs)
